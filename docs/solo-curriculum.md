...
- Not an AI tutor. Mapper and sentence builder are deterministic lookups over our corpus.
- Not shared-board state. Lessons, mapper hits, and lesson ticks live in the content package and this profile’s IndexedDB.
...
The first-slice board/sync/review loop is unchanged. This adds a **local Lessons** surface. Remaining limits: no studio audio, no human review badge, no adaptive tutoring, core-500 is everyday draft coverage rather than a frequency-ranked corpus from Leipzig/DWDS.
